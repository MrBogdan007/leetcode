        ...
        public void merge(int[] nums1, int m, int[] nums2, int n) {
            ...
            while( nums1Length >= 0 && nums2Length >= 0){
                if(nums1[nums1Length] > nums2[nums2Length]){
                    nums1[bothLength--] =  nums1[nums1Length--]; // changing element at the last index of both arrays(5 index and element 0 )
                                                                 // to the element at the last index of first array(3) 
